...
import { Button, Container, Card, Title, Text, TextInput, Group, Select, Stack, Center, Badge, Paper, ActionIcon, Tabs } from '@mantine/core';
import { IconSearch, IconBell, IconSpeakerphone, IconShieldCheck, IconRefresh, IconUserCheck, IconSettings, IconDoorEnter, IconDashboard } from '@tabler/icons-react';
import './module.css';
...
function VmsPage() {
  ...
  const currentTabList = activeNotificationTab === 'notifications' ? notifications : announcements;
    ...
    <Container size="xl" py="xl">
      ...
      <Group justify="space-between" align="flex-end" mb="xl" mt="md">
        <div>
          ...
          <Text c="dimmed" size="lg" mt="xs">Monitor notifications, manage visits, approvals, and secure the premises.</Text>
        </div>
      ...
      <Tabs value={currentTab} onChange={setCurrentTab} variant="pills" radius="md">
        <Tabs.List mb="lg">
            <Tabs.Tab value="overview" leftSection={<IconDashboard size={16} />}>
              Overview
            </Tabs.Tab>
            <Tabs.Tab value="security" leftSection={<IconDoorEnter size={16} />}>
              Security Gate Actions
            </Tabs.Tab>
            <Tabs.Tab value="host" leftSection={<IconUserCheck size={16} />}>
              Host Approvals
            </Tabs.Tab>
            ...
            <Stack gap="xl">
                ...
                <Group justify="space-between" mb="lg">
                  <Group gap="sm">
                    <Button 
                      ...
                      variant={activeNotificationTab === 'notifications' ? 'gradient' : 'subtle'} 
                      gradient={activeNotificationTab === 'notifications' ? { from: 'violet', to: 'blue' } : undefined}
                      color="violet" 
                    ...
                    <Button 
                      ...
                      variant={activeNotificationTab === 'announcements' ? 'gradient' : 'subtle'} 
                      gradient={activeNotificationTab === 'announcements' ? { from: 'violet', to: 'blue' } : undefined}
                      color="violet" 
                ...
                {sortedTabList.length === 0 ? (
                  <Center p="xl" style={{ minHeight: 250 }}>
                    <Stack align="center" gap="sm">
                      ...
                      <Title order={3}>No new {activeNotificationTab}!</Title>
              ...
              <Card shadow="xl" p="xl" radius="lg" withBorder className="glass-panel">
                <Group mb="md" align="center">
                  ...
                  <Title order={3}>Recent Security Incidents Log</Title>
                </Group>
          ...
          <Tabs.Panel value="security">
            <Stack gap="xl">
              ...
              <IncidentForm token={token} onActionSuccess={() => loadDashboardData(token)} />
